...
const FormList: React.FC = () => {
  ...
  return (
    <div className="w-full h-full">
          ...
          {formDb?.length > 0 &&
            formDb.map((form) => (
              <li
                ...
                className="flex items-center w-full p-1 border-b border-gray-300 cursor-pointer hover:bg-gray-100 hover:text-black transition-all"
              >
      ...
      {activeForm !== null && <FormDetail id={activeForm} />}
    </div>
  );
};
