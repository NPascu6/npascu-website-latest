...
const FormJSONEditor: React.FC<FormJSONEditorProps> = ({
  ...
  return (
    <div className="p-1 shadow-md rounded-lg border border-gray-300 h-[calc(100dvh-8em)] overflow-auto w-full">
          ...
          {editingField?.id === field.id ? (
            <div>
              ...
              <button
                ...
                className="mt-2 py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md shadow-md"
              >
                Save
              </button>
            </div>
